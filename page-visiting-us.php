...
<section id="comp-mkj6ux28" class="page-hero-strip">
    <div class="hero-bg-container">
        <img class="hero-bg-img" src="https://static.wixstatic.com/media/11062b_ade08d73d5a54a8bab0c6d549ef04a95~mv2.jpeg/v1/fill/w_1581,h_669,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/11062b_ade08d73d5a54a8bab0c6d549ef04a95~mv2.jpeg" alt="Golden Temple">
    </div>
...
<article class="page-content-section">
    <div class="page-content-container">
        ...
        <!-- Section 1: First Time Visitors -->
        <header class="page-content-header">
            <h1 class="page-title-main">First Time Visitors</h1>
        </header>
        ...
        <div class="page-landscape-image">
            <img src="https://static.wixstatic.com/media/11062b_fcc67ab2b060424fad9ea44851f2b067~mv2.jpg/v1/fill/w_1960,h_880,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Long%20Road.jpg" alt="First Time Visitors - Long Road">
        </div>
        ...
        <div class="page-landscape-image">
            <img src="https://static.wixstatic.com/media/11062b_ba6ed7b00a194d0294dd4e14524dae2e~mv2.jpg/v1/fill/w_1960,h_880,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Lake%20Sunset%20View.jpg" alt="First Time Visitors - Lake Sunset View">
        </div>
        ...
        <section class="visiting-contact-section">
            <div class="visiting-contact-grid">
                ...
                <div class="visiting-contact-image">
                    <img src="https://static.wixstatic.com/media/11062b_fb4edb4cc6f94a2eabbc76fbca4eebfa~mv2.jpg/v1/fill/w_926,h_900,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Sand.jpg" alt="Have a Question - Sand">
                </div>
                <!-- Right: Contact Form -->
