...
// backup menu shown if no menu is assigned in wp-admin
...
// adds search button to the main nav menu
...
// acf options page for things like social links
if ( function_exists('acf_add_options_page') ) {
    acf_add_options_page(array(
        'page_title'    => 'Sukh Sagar Settings',
        'menu_title'    => 'Sukh Sagar Settings',
        'menu_slug'     => 'sukh-sagar-settings',
