        ...
        <div class="footer-main-container">
                ...
                <div class="contact-details-list">
                    ...
                    <div class="contact-detail-item">
                        ...
                        <div class="contact-detail-text">
                            <a href="https://maps.google.com/?q=347+Wood+St,+New+Westminster,+BC" target="_blank" rel="noopener noreferrer">
                                347 Wood St<br>New Westminster, BC
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail-item">
                        ...
                        <div class="contact-detail-text">
                            <a href="tel:(604)537-8300">(604) 537-8300</a>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail-item">
                        ...
                        <div class="contact-detail-text">
                            <a href="mailto:info@sukhsagar.ca">info@sukhsagar.ca</a>
                        </div>
                    </div>
            ...
            <div class="footer-column footer-map-col">
                <div class="footer-map-wrapper">
                    <iframe title="Google Maps" src="https://maps.google.com/maps?q=Gurdwara%20Sahib%20Sukh%20Sagar,%20New%20Westminster,%20BC&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
    ...
    <div class="footer-copyright-strip">
        <div class="footer-copyright-container">
            <h6 class="copyright-text">
                &copy; 2026 Gurdwara Sahib Sukh Sagar
            </h6>
        </div>
    </div>
</footer>
